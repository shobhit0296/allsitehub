...
const THEME_STYLES: Record<string, ThemeConfig> = {
    midnight: {
        ...
        activeNavBg: "bg-indigo-600/30 border-indigo-500/50 shadow-sm",
        cardBorderHover: "hover:border-indigo-500/60",
        cardGlow: "hover:shadow-lg",
        accentBadge: "bg-indigo-950/70 text-indigo-300 border-indigo-500/30",
        heroGradient: "from-indigo-950/30 via-slate-900/60 to-[#090a0f]",
        btnGradient: "from-indigo-600 via-slate-700 to-indigo-500 hover:shadow-md",
    ...
    cyber: {
        ...
        activeNavBg: "bg-sky-600/30 border-sky-500/50 shadow-sm",
        cardBorderHover: "hover:border-sky-500/60",
        cardGlow: "hover:shadow-lg",
        accentBadge: "bg-sky-950/70 text-sky-300 border-sky-500/30",
        heroGradient: "from-sky-950/30 via-slate-900/60 to-[#0b0f19]",
        btnGradient: "from-sky-600 via-slate-700 to-sky-500 hover:shadow-md",
    ...
    emerald: {
        ...
        activeNavBg: "bg-emerald-600/30 border-emerald-500/50 shadow-sm",
        cardBorderHover: "hover:border-emerald-500/60",
        cardGlow: "hover:shadow-lg",
        accentBadge: "bg-emerald-950/70 text-emerald-300 border-emerald-500/30",
        heroGradient: "from-emerald-950/30 via-slate-900/60 to-[#06140e]",
        btnGradient: "from-emerald-600 via-teal-700 to-emerald-500 hover:shadow-md",
    ...
    ocean: {
        ...
        activeNavBg: "bg-blue-600/30 border-blue-500/50 shadow-sm",
        cardBorderHover: "hover:border-blue-500/60",
        cardGlow: "hover:shadow-lg",
        accentBadge: "bg-blue-950/70 text-blue-300 border-blue-500/30",
        heroGradient: "from-blue-950/30 via-slate-900/60 to-[#080d1a]",
        btnGradient: "from-blue-600 via-slate-700 to-blue-500 hover:shadow-md",
    ...
    sunset: {
        ...
        activeNavBg: "bg-amber-600/30 border-amber-500/50 shadow-sm",
        cardBorderHover: "hover:border-amber-500/60",
        cardGlow: "hover:shadow-lg",
        accentBadge: "bg-amber-950/70 text-amber-300 border-amber-500/30",
        heroGradient: "from-amber-950/30 via-slate-900/60 to-[#120e06]",
        btnGradient: "from-amber-600 via-slate-700 to-amber-500 hover:shadow-md",
    ...
    crimson: {
        ...
        activeNavBg: "bg-rose-600/30 border-rose-500/50 shadow-sm",
        cardBorderHover: "hover:border-rose-500/60",
        cardGlow: "hover:shadow-lg",
        accentBadge: "bg-rose-950/70 text-rose-300 border-rose-500/30",
        heroGradient: "from-rose-950/30 via-slate-900/60 to-[#12080a]",
        btnGradient: "from-rose-600 via-slate-700 to-rose-500 hover:shadow-md",
        ...
        <div className="min-h-screen flex flex-col bg-[#05050c] text-slate-100 font-sans selection:bg-purple-600 selection:text-white relative overflow-x-hidden">
            ...
            <header className="sticky top-0 z-50 glass-nav-dark px-4 sm:px-8 xl:px-12 py-3.5 transition-all border-b border-slate-800/80">
                <div className="max-w-[1700px] w-full mx-auto flex items-center justify-between gap-4">
                    ...
                    {/* Right Header Items: Badges, Theme, Region, Live Counter */}
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div className="relative hidden sm:block">
                            ...
                            >
                                ...
                                <option value="cyber">🏢 Deep Slate</option>
                                <option value="emerald">🟢 Emerald Dark</option>
                                <option value="ocean">🌊 Oceanic Navy</option>
                                <option value="sunset">☀️ Amber Dark</option>
            ...
            <main className="flex-1 max-w-[1700px] w-full mx-auto px-4 sm:px-8 xl:px-12 py-6 sm:py-12 flex flex-col gap-8 sm:gap-14">
                ...
                <section id="browse-directory" className="flex flex-col gap-6 pt-4 sm:pt-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
                        ...
                        <aside className="lg:col-span-3 flex flex-col gap-3 sticky top-20 self-start bg-[#090717]/95 border border-purple-500/30 rounded-3xl p-4 sm:p-5 shadow-[0_0_30px_rgba(168,85,247,0.15)] transition-all">
                            ...
                            >
                                <div className="flex items-center gap-3 relative z-10">
                                    <div className="w-10 h-10 rounded-xl bg-[#FF4500] flex items-center justify-center text-xl text-white shadow-[0_0_15px_rgba(255,69,0,0.6)] group-hover:scale-110 transition-transform shrink-0">
